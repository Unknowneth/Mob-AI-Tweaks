...
public abstract class RangedCrossbowAttackTaskMixin {
    ...
    @ModifyConstant(method = "tickState", constant = @Constant(intValue = 20), require = 0)
    private int changeDefaultRangedAttack(int constant, @Local(name = "entity") MobEntity actor) {
